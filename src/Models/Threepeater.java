public class Threepeater extends AttackerPlant
{
    ...
    private Threepeater(String name, String type, int health, int coolDownTime, int requiredSuns, boolean cactusEffect,
    ...
    public static void putThreepeater(Cell coordination)
    {
        ...
        if (firstCo != null)
        {
            threepeater.firstPea = new AttackerPlant("Threepeater" , "Land" , 5 , 4 , 3 ,
